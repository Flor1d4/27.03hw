...
namespace _27._03hw
{
    internal class Program
    {
        ...
        abstract class Decorator : Klass
        {
            protected Klass professsion;

            public Decorator(Klass professsion)
            {
                this.professsion = professsion;
            }

            public void SetProfesssion(Klass professsion)
            {
                this.professsion = professsion;
            }
            public override string Operation()
        ...
        public class Client
        {
            public void ClientCode(Klass Professsion)
            {
